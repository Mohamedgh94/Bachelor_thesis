...
class Main:
    def __init__(self, model, loss_fn):
        ...
        self.model_saver = SaveAndLoadModel(self.model, self.optimizer, self.loss_fn, self.model_path)
...
if __name__ == "__main__":
    vocab_size = 5000  # Replace with your actual vocabulary size
    ...
    model = GatedTransformer(vocab_size, d_model, num_heads, d_ff, num_layers)

    loss_fn = loss  # Your custom loss function
